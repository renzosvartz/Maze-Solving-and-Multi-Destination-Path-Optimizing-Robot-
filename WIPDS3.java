...
public class WIPDS3
{
    ...
    public void point_to_point(String source, String destination) 
    {
        ...
        {
            head_to(vertices.get(source), vertices.get(destination));
        }
        ...
        else if (ids.containsKey(source) && !ids.containsKey(destination))
        {
            ...
            if (vertex_b == null)
            {
                head_to(vertices.get(source), vertex_a);
            ...
            else
            {
                ...
                djikstras_best_path_between(vertices.get(source), vertex_a, cost_a);
                cost_a.add_cost(hallway.get_cost_a());

                Cost cost_b = new Cost();
                djikstras_best_path_between(vertices.get(source), vertex_b, cost_b);
                ...
                {
                    head_to(vertices.get(source), vertex_b);
        ...
        else if (!ids.containsKey(source) && ids.containsKey(destination))
        {
            ...
            if (vertex_b == null)
            {
                ...
                head_to(vertex_a, vertices.get(destination));
            }
            else
            {
                Cost cost_a = new Cost();
                djikstras_best_path_between(vertex_a, vertices.get(destination), cost_a);
                cost_a.add_cost(hallway.get_cost_a());

                Cost cost_b = new Cost();
                djikstras_best_path_between(vertex_b, vertices.get(destination), cost_b);
                cost_b.add_cost(hallway.get_cost_b());
                ...
                else
                {
                    ...
                    head_to(vertex_b, vertices.get(destination));
                }
            }
        }
        ...
        else
        {
            ...
            djikstras_best_path_between(vertex_sa, vertex_da, cost_aa);
            ...
            if (destination_hallway.get_b() != null)
            {
                ...
                djikstras_best_path_between(vertex_sa, vertex_db, cost_ab);
            ...
            if (source_hallway.get_b() != null)
            {
                ...
                djikstras_best_path_between(vertex_sb, vertex_da, cost_ba);
            ...
            if (source_hallway.get_b() != null && destination_hallway.get_b() != null)
            {
                ...
                djikstras_best_path_between(vertex_sb, vertex_db, cost_bb);
    ...
    public Stack<String> djikstras_best_path_between(Custom_Vertex source_vertex, Custom_Vertex destination_vertex, Cost path_cost)
    {
    ...
    {
        Stack<String> stack_of_vertex_names = djikstras_best_path_between(current_vertex, vertex_to_visit, null);
